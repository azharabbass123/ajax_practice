    ...
    <div class="container mx-auto">
        <div class="max-w-md mx-auto my-10">
            <div class="text-center">
                <h1 class="my-3 text-3xl font-semibold text-gray-700 dark:text-gray-200">Register Without AJAX</h1>
            ...
            <div class="m-7">
                <form method="POST">
                    ...
                    <div class="mb-6">
                        <button type="submit" class="w-full px-3 py-3 text-white bg-indigo-500 rounded-md focus:bg-indigo-600 focus:outline-none">Register</button>
                    </div>
